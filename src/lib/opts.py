  ...
  def __init__(self):
    ...
    self.parser.add_argument('--trainval', action='store_true',
                             help='include validation in training and '
                                  'test on test set')
    self.parser.add_argument('--use_roi_align', type=int, default=0,
                             help='whether to use roi_align to get crop features')
    self.parser.add_argument('--graph_model_params', type=str, default='tracking_cfg.yaml', help='load graph model params')
